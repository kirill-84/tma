...
function App() {
    ...
    return (
        ...
        <div className="App">
            ...
            <div className="mt-2">
                For inspiration: 0x1266...6d63 <svg title="Copy to clipboard" onClick={() => copyText("0x1266a05165458ce7b2C120FB744887f40eca6d63")} className="inline-block cursor-pointer" width="32px" height="32px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
