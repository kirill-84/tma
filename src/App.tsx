...
function App() {
    ...
    return (
        ...
        <div className="App">
            ...
            <div className="mt-2">
                For inspiration: UQBw...o5FI <svg onClick={() => copyText("UQBwJX9X7no3RSaiHM9dke-3sI-tS37IK_zUmvhOrzU8o5FI")} className="inline-block cursor-pointer" width="24px" height="24px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><title>Copy to clipboard</title>
