...
function App() {
    ...
    return (
        ...
        <div className="App">
            ...
            <div className="mt-2">
                For inspiration: UQCT...ESYA <svg onClick={() => copyText("UQCTmlmrH5rZfFN-kFsvFl0TwyF6OS5sp3QEn8nNWnW0ESYA")} className="inline-block cursor-pointer" width="21px" height="21px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><title>Copy to clipboard</title>
